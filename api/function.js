function post_create() {
    ...
    axios.post('https://pacific-coast-71393.herokuapp.com/employee', {
...
function get_all() {
    axios.get('https://pacific-coast-71393.herokuapp.com/employees')
        .then(function (response) {
            console.log(response);
            $html = '';
...
function update_student($obj) {
    ...
    axios.put('https://pacific-coast-71393.herokuapp.com/employee/' + id, {
        student_name:student_name,father_name:father_name,age:age,roll_no:roll_no
    }).then(response => {
        console.log(response);
...
function delete_student($obj) {
    ...
    axios.delete('https://pacific-coast-71393.herokuapp.com/employee/' + id)
        .then(function (response) {
            console.log(response);
